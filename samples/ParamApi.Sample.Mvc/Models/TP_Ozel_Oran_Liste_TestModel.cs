...
/// <summary>
/// TP_Ozel_Oran_Liste test sayfası için view model
/// </summary>
public class TP_Ozel_Oran_Liste_TestModel
{
    // Bu method parametre almıyor, sadece çağrılıyor
}

/// <summary>
/// TP_Ozel_Oran_Liste sonuç sayfası için view model
/// </summary>
public class TP_Ozel_Oran_Liste_ResultModel
{
    /// <summary>
    /// API Response
    /// </summary>
    public TP_Ozel_Oran_Liste_Response? Response { get; set; }
