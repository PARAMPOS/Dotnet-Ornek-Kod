...
/// <summary>
/// TP_Islem_Odeme_BKM BKM Express callback parametreleri için model
/// </summary>
public class TP_Islem_Odeme_BKM_CallbackModel
{
    /// <summary>
    /// Sonuç değeri
    /// </summary>
    ...
    /// TURKPOS_RETVAL_Dekont_ID değeri "0" dan büyük olduğu durumlarda kredi kartından çekim işlemi tamamlanmış anlamına gelir
    /// </summary>
    ...
    /// <summary>
    /// BKM Express ödemesi tamamlanmış mı kontrolü
    /// </summary>
    public bool IsBkmPaymentCompleted => IsSuccess && !string.IsNullOrEmpty(TURKPOS_RETVAL_Dekont_ID) && TURKPOS_RETVAL_Dekont_ID != "0";
} 