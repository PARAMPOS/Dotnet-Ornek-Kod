...
/// <summary>
/// TP_Ozel_Oran_SK_Guncelle test sayfası için view model
/// </summary>
public class TP_Ozel_Oran_SK_Guncelle_TestModel
{
    /// <summary>
    ...
    /// <summary>
    /// Örnek SK ID'leri (test amaçlı)
    /// </summary>
    public static List<long> SampleSKIds => new()
    {
...
/// <summary>
/// TP_Ozel_Oran_SK_Guncelle sonuç sayfası için view model
/// </summary>
public class TP_Ozel_Oran_SK_Guncelle_ResultModel
{
    /// <summary>
    /// Gönderilen request bilgileri
    /// </summary>
    public TP_Ozel_Oran_SK_Guncelle_TestModel? Request { get; set; }

    /// <summary>
    /// API Response
    /// </summary>
    public TP_Ozel_Oran_SK_Guncelle_Response? Response { get; set; }
